...
-- create the OrderItems table, used to help define quantity of items ordered by distributor
...
-- create the Supply Orders table
...
-- insert Time_Record records 
 ...
 VALUES('1','2026-02-20','12');  
 INSERT INTO Time_Record(EmployeeID,WorkDate,HoursWorked)
 VALUES('2','2026-02-20','10');  
 INSERT INTO Time_Record(EmployeeID,WorkDate,HoursWorked)
 VALUES('3','2026-02-20','18');  
 INSERT INTO Time_Record(EmployeeID,WorkDate,HoursWorked)
 VALUES('4','2026-02-20','16');  
 INSERT INTO Time_Record(EmployeeID,WorkDate,HoursWorked)
 VALUES('5','2026-02-20','8');  
 INSERT INTO Time_Record(EmployeeID,WorkDate,HoursWorked)
 VALUES('6','2026-02-20','7');  
 INSERT INTO Time_Record(EmployeeID,WorkDate,HoursWorked)
 VALUES('7','2026-02-20','5'); 
 INSERT INTO Time_Record(EmployeeID,WorkDate,HoursWorked)
 VALUES('1','2026-02-21','6');  
...
-- insert Wine records
INSERT INTO Wine(WineName, QuantityStocked)
 VALUES('Chardonnay', '12');
INSERT INTO Wine(WineName, QuantityStocked)
 VALUES('Merlot', '45');
 INSERT INTO Wine(WineName, QuantityStocked)
 VALUES('Cabernet', '792');
...
INSERT INTO DistributorWine(DistributorID,WineID)
 VALUES(1,1);
 INSERT INTO DistributorWine(DistributorID,WineID)
 VALUES(1,4);
INSERT INTO DistributorWine(DistributorID,WineID)
...
INSERT INTO Supplier(SupplierName)
 VALUES('Bottles and Corks INC');
INSERT INTO Supplier(SupplierName)
 VALUES('Labels and Boxes INC');
INSERT INTO Supplier(SupplierName)
 VALUES('Vats and Tubing INC');
 
 -- insert Supplies records
INSERT INTO Supplies(ItemName, QuantityStocked, SupplierID)
 VALUES('Bottles', '500', '1');
INSERT INTO Supplies(ItemName, QuantityStocked, SupplierID)
 VALUES('Corks', '1000', '1');
INSERT INTO Supplies(ItemName, QuantityStocked, SupplierID)
 VALUES('Labels', '200', '2');
...
INSERT INTO Supply_Orders(SupplierID, ItemID, QuantityOrdered, ExpectedDeliveryDate, ActualDeliveryDate)
 VALUES('1', '1', '15', '2026-03-14', NULL);
 INSERT INTO Supply_Orders(SupplierID, ItemID, QuantityOrdered, ExpectedDeliveryDate, ActualDeliveryDate)
 VALUES('1', '2', '2', '2026-03-03', NULL);
 INSERT INTO Supply_Orders(SupplierID, ItemID, QuantityOrdered, ExpectedDeliveryDate, ActualDeliveryDate)
 VALUES('2', '3', '50', '2026-03-07', NULL);
 INSERT INTO Supply_Orders(SupplierID, ItemID, QuantityOrdered, ExpectedDeliveryDate, ActualDeliveryDate)
 VALUES('2', '4', '100', '2026-03-01', '2026-02-27');
 INSERT INTO Supply_Orders(SupplierID, ItemID, QuantityOrdered, ExpectedDeliveryDate, ActualDeliveryDate)
 VALUES('3', '5', '19', '2026-03-10', NULL);
 INSERT INTO Supply_Orders(SupplierID, ItemID, QuantityOrdered, ExpectedDeliveryDate, ActualDeliveryDate)
 VALUES('3', '6', '26', '2026-03-10', NULL);
...
INSERT INTO OrderItems(WineID, OrderID, OrderQuantity)
 VALUES('1','1','10');
INSERT INTO OrderItems(WineID, OrderID, OrderQuantity)
 VALUES('1','2','20');
INSERT INTO OrderItems(WineID, OrderID, OrderQuantity)
